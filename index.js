...
var defaultConfig = {
  fromEmail: "no-reply@autodesk.io",
  subjectPrefix: "",
  emailBucket: "adn-ses-2018",
  emailKeyPrefix: "ses/",
  forwardMapping: {
    "no-reply@autodesk.io": [
      "adn-ses@autodesk.com"
    ],
    "webmaster@autodesk.io": [
      "adn.sparks@autodesk.com"
    ],
    "admin@autodesk.io": [
      "adn.sparks@autodesk.com"
    ],
    "lucille@autodesk.io": [
      "fauvel.lucille@yahoo.com"
    ]
  }
};
